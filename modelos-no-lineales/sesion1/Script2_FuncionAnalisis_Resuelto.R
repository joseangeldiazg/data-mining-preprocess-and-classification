...
datos <-data.frame( y=iris$Sepal.Width,
                    ...
                    x3=iris$Petal.Width)
library(splines)
model.ejercicio51 <- lm(y~bs(x1), data = datos)
model.ejercicio51.Resultado <- Analisis(datos,model.ejercicio51)

model.ejercicio52 <- lm(y~bs(x2), data = datos)
model.ejercicio52.Resultado <- Analisis(datos,model.ejercicio52)

model.ejercicio53 <- lm(y~bs(x3), data = datos)
model.ejercicio53.Resultado <- Analisis(datos,model.ejercicio53)

model.ejercicio54 <- lm(y~bs(x1)+bs(x2)+bs(x3), data = datos)
model.ejercicio54.Resultado <- Analisis(datos,model.ejercicio54)

model.ejercicio55 <- lm(y~bs(x1)*bs(x2)*bs(x3), data = datos)
model.ejercicio55.Resultado <- Analisis(datos,model.ejercicio55)
...
# Apartado a
model.ejercicio7a1 <- lm (y~poly(x1,3), data = datos)
model.ejercicio7a1.Resultado <- Analisis(datos,model.ejercicio7a1)

model.ejercicio7a2 <- lm (y~poly(x2,3), data = datos)
model.ejercicio7a2.Resultado <- Analisis(datos,model.ejercicio7a2)

model.ejercicio7a3 <- lm (y~poly(x1,3)+poly(x2,3), data = datos)
model.ejercicio7a3.Resultado <- Analisis(datos,model.ejercicio7a3)

model.ejercicio7a4 <- lm (y~poly(x1,3)*poly(x2,3), data = datos)
model.ejercicio7a4.Resultado <- Analisis(datos,model.ejercicio7a4)
...
model.ejercicio7b1 <- lm (y~bs(x1), data = datos)
model.ejercicio7b1.Resultado <- Analisis(datos,model.ejercicio7b1)

model.ejercicio7b2 <- lm (y~bs(x2), data = datos)
model.ejercicio7b2.Resultado <- Analisis(datos,model.ejercicio7b2)

model.ejercicio7b3 <- lm (y~bs(x1)+bs(x2), data = datos)
model.ejercicio7b3.Resultado <- Analisis(datos,model.ejercicio7b3)

model.ejercicio7b4 <- lm (y~bs(x1)*bs(x2), data = datos)
model.ejercicio7b4.Resultado <- Analisis(datos,model.ejercicio7b4)
...
model.ejercicio7c1 <- gam (y~s(x1,4), data = datos)
model.ejercicio7c1.Resultado <- Analisis(datos,model.ejercicio7c1)

model.ejercicio7c2 <- gam (y~s(x2,4), data = datos)
model.ejercicio7c2.Resultado <- Analisis(datos,model.ejercicio7c2)

model.ejercicio7c3 <- gam (y~s(x1,4)+s(x2,4), data = datos)
model.ejercicio7c3.Resultado <- Analisis(datos,model.ejercicio7c3)

model.ejercicio7c4 <- gam (y~s(x1,4)*s(x2,4), data = datos)
model.ejercicio7c4.Resultado <- Analisis(datos,model.ejercicio7c4)
